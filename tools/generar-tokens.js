...
const SEMILLAS = [
  ...
  ["bg", "#4f46e5",  "ac",        "#6366f1", "acento sólido"],
  ...
  ["fg", "#888",     "tx-5",      "#7d8294", "texto apagado legacy"],
  ["fg", "#d1d5db",  "tx-6",      "#6e7387", "texto de vacío / marcador"],
  ...
  ["bd", "#e5e7eb",  "bd",        "#2e3140", "borde general"],
  ["bd", "#e0e0e0",  "bd-2",      "#333747", "borde alternativo"],
  ["bd", "#d1d5db",  "bd-3",      "#3c4052", "borde de campo"],
  ["bd", "#f0f0f0",  "bd-4",      "#262936", "separador de fila"],
  ["bd", "#e2e8f0",  "bd-5",      "#2b2e3c", "borde slate"],
  ...
  ["bd", "#d7dbe3",  "bd-6",      "#313443", "borde gris azulado"],
];
